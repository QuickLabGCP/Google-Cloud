...
**_Click the Develop tab and then select the qwiklabs-ecommerce LookML project._**

**_To create the file at the project’s root level, click the + button at the top of the file browser in the Looker IDE._**

**_Select Create View. Name the file _**`users_limited`**_. Click Create._**
...
**_In the file browser, under the models folder, navigate to the `training_ecommerce.model` file._**
